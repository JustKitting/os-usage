...
const LEVELS: &[LevelInfo] = &[
    ...
    LevelInfo { name: "Level 10", desc: "Find the right button",    route: Route::Level5 {} },
    LevelInfo { name: "Level 11", desc: "Click the right toggle",   route: Route::Level6 {} },
    LevelInfo { name: "Level 12", desc: "Type into the right input", route: Route::Level7 {} },
    LevelInfo { name: "Level 13", desc: "Accordion",                route: Route::Level21 {} },
    // --- Multi-element compound ---
    LevelInfo { name: "Level 14", desc: "Multi-dropdown",           route: Route::Level8 {} },
    LevelInfo { name: "Level 15", desc: "Mixed inputs",             route: Route::Level9 {} },
    LevelInfo { name: "Level 16", desc: "Form submission",          route: Route::Level10 {} },
    // --- Complex compound ---
    LevelInfo { name: "Level 17", desc: "Carousel reading",         route: Route::Level11 {} },
    LevelInfo { name: "Level 18", desc: "Grid form",                route: Route::Level12 {} },
    LevelInfo { name: "Level 19", desc: "Table input",              route: Route::Level13 {} },
    LevelInfo { name: "Level 20", desc: "License agreement",        route: Route::Level14 {} },
    LevelInfo { name: "Level 21", desc: "Drag & drop",              route: Route::Level15 {} },
    LevelInfo { name: "Level 22", desc: "Modal dialog",             route: Route::Level22 {} },
    LevelInfo { name: "Level 23", desc: "Context menu",             route: Route::Level23 {} },
    LevelInfo { name: "Level 24", desc: "Search autocomplete",      route: Route::Level24 {} },
    LevelInfo { name: "Level 25", desc: "Sortable list",            route: Route::Level25 {} },
    LevelInfo { name: "Level 26", desc: "Multi-select tags",        route: Route::Level26 {} },
    LevelInfo { name: "Level 27", desc: "Toast dismiss",            route: Route::Level27 {} },
];
